...
ClassicEditor.defaultConfig = {
	fontColor: {
		colors: [
			...
			{
				color: 'rgba(244, 255, 129, 1)',
				label: 'Lime A100'
			},
			{
				color: 'rgba(238, 255, 65, 1)',
				label: 'Lime A200'
			},
			{
